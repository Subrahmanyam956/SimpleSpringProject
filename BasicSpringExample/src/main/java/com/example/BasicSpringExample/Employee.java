...
public class Employee {
	...
	public Employee(String firstName, String lastName){
		...
		System.out.println("Do you wish to give alternate email id ? enter y for YES or n for NO");
		String alternateMail =  sc.next();
		if(alternateMail.equalsIgnoreCase("Y")) {
			takeAlternateEmailId(sc);
			System.out.println("Your Alternate Email Id : "+this.alternateEmailId);
		}	
	}
